...
arrayCivVeh = if !(hayIFA) then
	{
	["C_Hatchback_01_F","C_Hatchback_01_sport_F","C_Offroad_01_F","C_SUV_01_F","C_Van_01_box_F","C_Van_01_fuel_F","C_Van_01_transport_F","C_Truck_02_transport_F","C_Truck_02_covered_F","C_Offroad_02_unarmed_F","C_Van_02_transport_F","C_Tractor_01_F"];
	}
else
	{
...
medics = SDKMedic + [(FIAsquad select ((count FIAsquad)-1)),NATOMedic,(NATOSpecOp select ((count NATOSpecOp)-1)),CSATMedic,(CSATSpecOp select ((count CSATSpecOp)-1))];
...
arrayCivs = if (worldName == "Tanoa") then
	...
	if !(hayIFA) then
		{
		["C_man_1","C_man_1_1_F","C_man_1_2_F","C_man_1_3_F","C_man_hunter_1_F","C_man_p_beggar_F","C_man_p_beggar_F_afro","C_man_p_fugitive_F","C_man_p_shorts_1_F","C_man_polo_1_F","C_man_polo_2_F","C_man_polo_3_F","C_man_polo_4_F","C_man_polo_5_F","C_man_polo_6_F","C_man_shorts_1_F","C_man_shorts_2_F","C_man_shorts_3_F","C_man_shorts_4_F","C_scientist_F","C_Orestes","C_Nikos","C_Nikos_aged","C_Man_Messenger_01_F","C_Man_UtilityWorker_01_F","C_Man_Fisherman_01_F","C_Man_1_enoch_F","C_Man_2_enoch_F","C_Man_3_enoch_F","C_Man_6_enoch_F","C_Farmer_01_enoch_F"]
		}
	else
		{
