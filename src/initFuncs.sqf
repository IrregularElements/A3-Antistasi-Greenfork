...
RES_Squad = compile preprocessFileLineNumbers "Missions\RES_Squad.sqf";
DES_VehicleStuck = compile preprocessFileLineNumbers "Missions\DES_VehicleStuck.sqf";
LOG_SeaSupply = compile preprocessFileLineNumbers "Missions\LOG_SeaSupply.sqf";
