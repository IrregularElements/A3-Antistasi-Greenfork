class A3A
{
	...
	class AI
	{
        ...
        class artySupportAI {file="AI\artySupportAI.sqf";};
        class askForEngineer {file="AI\askForEngineer.sqf";};
        ...
        class isWindowed {file="AI\Buildings\isWindowed.sqf";};
        class returnRooftops {file="AI\Buildings\returnRooftops.sqf";};
        class isInRoof {file="AI\Buildings\isInRoof.sqf";};
        class moveToBuildingPos {file="AI\Buildings\moveToBuildingPos.sqf";};
        ...
        class globalInfoShare {file="AI\globalInfoShare.sqf";};
        ...
        class placeMines {file="AI\placeMines.sqf";};
        ...
        class pickHighestGround {file="AI\pickHighestGround.sqf";};
	...
	class CREATE
	{
        ...
        class garrisonReorgTemplates {file="CREATE\garrisonReorgTemplates.sqf";};
