...
if (isServer and !_byPassServer) then
	...
	["securedCities"] call fn_LoadStat;
	...
	if (hayIFA) then {unlockedRifles = unlockedRifles - ["LIB_M2_Flamethrower","LIB_PTRD"]; unlockedGL = unlockedGL - ["LIB_M2_Flamethrower","LIB_PTRD"]};
